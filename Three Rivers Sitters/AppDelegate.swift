...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        FIRApp.configure()
    Stripe.setDefaultPublishableKey("pk_test_jHYkklTnOFc40EBjUza4ovIu")
        
        //FIRDatabase.database().persistenceEnabled = true
        
        OneSignal.setLogLevel(.LL_VERBOSE, visualLevel: .LL_NONE)
        
        OneSignal.initWithLaunchOptions(launchOptions, appId: "67f3b1fd-56a1-42aa-80f5-088e09de59f3")
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "ThreeRiversSitters")
